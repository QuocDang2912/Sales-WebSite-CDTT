        ...
        <div className="container">
          <div className="row">
                ...
                <div className="filter_price">
                  <form onSubmit={handleSubmit}>
                    ...
                    <SliderFilter
                      ...
                      max={20000000} // Chỗ đã sửa: Đặt giá trị max cho SliderFilter
            ...
            <div className="col-md-9 order-1 order-md-2">
              <div className="row align-items-center" style={{ marginTop: "-22px", marginRight:"-82px", marginLeft:"1px" }}>
                <h2 className="section-title heading-border ls-20 border-0 col-md-8">
                  Tất cả sản phẩm
                </h2>
                <div
