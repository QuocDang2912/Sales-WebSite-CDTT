...
export default function ProductCategory() {
    ...
    useEffect(() => {
        ...
        (
            async () => {
                const res = await ProductServie.productCategory_price(slug, currentPage, minPrice, maxPrice, sort_order)
                console.log("🚀 ~ res:", res)
    ...
    const handleSubmit = (event) => {
        ...
        (
            async () => {
                const res = await ProductServie.productCategory_price(slug, currentPage, filter.minPrice, filter.maxPrice, sort_order)
                console.log("🚀 ~ res:", res)
                setProductCategory(res.products.data)
                setCurrentPage(res.products.current_page);
                setLastPage(res.products.last_page);
